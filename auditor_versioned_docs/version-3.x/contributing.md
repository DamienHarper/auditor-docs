...
```
  ...
  Note
  Connection parameters (username, password, host, port, etc) are set in <code>phpunit.mysql.xml</code> file.
...
```
  ...
  Note
  Connection parameters (username, password, host, port, etc) are set in <code>phpunit.pgsql.xml</code> file.
...
```
  ...
  Note
  Connection parameters (username, password, host, port, etc) are set in <code>phpunit.mariadb.xml</code> file.
